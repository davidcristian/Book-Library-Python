...
class RentalService:
    ...
    """
    def __init__(self, rental_repo, book_repo, client_repo, preload=False):
        """
    ...
    def create_rental(self, rental_id, book_id, client_id, start=datetime.today().strftime('%Y/%m/%d')):
        """
    ...
    def return_rental(self, rental_id, end=datetime.today().strftime('%Y/%m/%d')):
        """

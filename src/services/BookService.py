...
class BookService:
    ...
    """
    def __init__(self, repository, rental_service, preload=False):
        """
    ...
    def preload(self):
        ...
        books = ["guardian of the north", "butterfly without courage", "compansions of desire", "turtles of hell", "wives and giants", "enemies and criminals", "bane of the eternal", "concept of dusk", "raised by my past", "pleasing the titans", "boy of desire", "priestess without desire", "women of the void", "blacksmiths of dusk", "women and spiders", "hunters and descendants", "decay of glory", "bane of the prison", "hunting the sea", "pleasing nature", "opponent with immortality", "fish without flaws", "lions of the great", "pirates of nightmares", "spies and rats", "companions and fish", "effect of dawn", "death of the stockades", "amusing the north", "dead at the nation", "ancestor of fire", "spy of the forsaken", "supporters of doom", "ancestors of the world", "horses and builders", "rebels and women", "effect of heaven", "decisions of limbo", "separated in the abyss", "death to the north", "enchanter of greatness", "stranger without courage", "wolves of the ancestors", "imps of the eternal", "descendants and children", "women and slaves", "fruit of utopia", "failure of the era", "blinded by the immortals", "preparing for a storm", "doctor during lunch", "mutant of the void", "visitors in the attic", "dogs in my closet", "children and zombies", "hunters and humans", "ambushed in the field", "screams in the fog", "humble in the north", "motionless in the end", "devil in the library", "butcher in the attic", "students without teeth", "colleagues with white hair", "humans and foreigners", "serpents and ghosts", "noises under my bed", "lost at the convention", "crazy in the city", "somber until the chasm", "thief secret", "robot with a hat", "robot with big eyes", "agent affair", "comedian and queen", "wife and officer", "pranks in the window", "buckets with big eyes", "stupidity of my village", "favorite of money", "guardian of tomorrow", "dog of an insect", "lords of the caves", "turtles of the stars", "vultures and mice", "vultures and butchers", "passage of the river", "mystery of the void", "astonished by dreams", "muted by a storm", "athletes of medicine", "preys with tradition", "vultures with style", "sinners of the universe", "spirits and insects", "flowers and politicians", "volcanoes of technology", "cities of science", "safe tomorrow", "life with biology"]

        for iterator in range(20):
            self.__repository.get_repo().append(Book(iterator, books[randint(0, len(books) - 1)].title(),

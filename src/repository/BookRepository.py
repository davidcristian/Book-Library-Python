...
class BookRepository(Iterable):
    ...
    def search_book_by_id(self, book_id):
        ...
        """
        return Iterable.filter(self._repo, lambda x: x.get_book_id() == book_id)
    ...
    def search_book_by_title(self, book_title):
        ...
        """
        return Iterable.filter(self._repo, lambda x: book_title.strip().lower() in x.get_title().strip().lower())
    ...
    def search_book_by_author(self, book_author):
        ...
        :return: the list of books matching the given criterion
        """
        return Iterable.filter(self._repo, lambda x: book_author.strip().lower() in x.get_author().strip().lower())
